...
<AccordionGroup>
  ...
  Run Sourcebot within your own infrastructure. Check out our [self-hosting](http://localhost:3000/self-hosting/overview) guide to get started (it takes < 1 minute to spin up)
...
Once you know which Sourcebot deployment you want to use, check out the [Getting Started](/docs/getting-started) page
# Platform Support
