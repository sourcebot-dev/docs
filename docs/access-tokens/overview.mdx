...
<AccordionGroup>
    ...
    <Accordion title="Create a GitHub Access Token">
        ...
        Once you've created your GitHub PAT, add is as a [secret](access-tokens/secrets) in Sourcebot to use it within your connections
    </Accordion>
    ...
    <Accordion title="Create a GitLab Access Token">
        ...
        Once you've created your GitLab PAT, add is as a [secret](access-tokens/secrets) in Sourcebot to use it within your connections
    </Accordion>
</AccordionGroup>