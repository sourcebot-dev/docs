...
Navigate to `localhost:3000` to see your Sourcebot deployment in action. Check out the README on our [GitHub](https://github.com/sourcebot-dev/sourcebot) for instructions on how to configure your deployment.
