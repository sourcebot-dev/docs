...
Navigate to `localhost:3000` to see your Sourcebot deployment in action. Check out our [Getting Started](/docs/getting-started) guide to learn how to index your repos and use the tool.
